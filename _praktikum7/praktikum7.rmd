---
title: 'Rakendustarkvara: R. Sügis 2018, 7. praktikum^[Praktikumijuhendid põhinevad aine MTMS.01.092 Rakendustarkvara: R (2 EAP) materjalidel, mille autorid on Mait Raag ning Raivo Kolde]'
output: 
  html_document:
    theme: null
...
# http://kodu.ut.ee/~annes/R/mass0.txt   andmefail, kus pole reanumbreid!
mass0 <- fread("http://kodu.ut.ee/~annes/R/mass0.txt")
str(mass0)
