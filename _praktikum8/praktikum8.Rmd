---
title: 'Rakendustarkvara: R. Sügis 2018, 8. praktikum^[Praktikumijuhendid põhinevad aine MTMS.01.092 Rakendustarkvara: R (2 EAP) materjalidel, mille autorid on Mait Raag ning Raivo Kolde]'
output: 
  html_document:
    theme: null
...
`andmed <- read.table(str_c(link, "mass.txt"), sep = "\t", header = T)`\linebreak
