...
Loe töölauale andmestik `haigla`, mille saad alla laadida ÕISist. See sisaldab infot patsientide haiglasse saabumise(`haiglasse.kp`) ja lahkumise(`haiglast.kp`) kuupäevade kohta.

```{r eval = F}
# file.choose() avab akna, kus saab faili valida.
haigla <- read.csv2(file.choose(), colClasses = c("integer", "Date", "Date"))
```
