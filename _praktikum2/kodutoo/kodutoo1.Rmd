...
Faili nimeks pane `<initsiaal>_<perekonnanimi>_Rkodutöö_<nr>.R`. Näiteks `K_Lumiste_Rkodutöö_1.R` ja saada e-postile kaur.lumiste@ut.ee **hiljemalt 20. septembriks, kella 16:00-ks (1. rühm), 8. novembriks, kella 16:00-ks (rühm2)** ehk praktikumi alguseks.

Iga ülesande õige vastus annab 1 punkti ning kodutöö edukaks sooritamiseks on vajalik saada vähemalt 50% punktidest. Kui mõni ülesanne valmistab raskusi või mõnest kohast ei saa edasi, siis on võimalus abi küsida esmaspäevases praktikumis.
...
2. Vali temperatuurivektorist elemendid, mis on paarisarvulistel kohtadel (paarisarvulise vektori moodustamiseks kasuta funktsiooni `seq()`). Omista saadud alamvektor muutujale `vastus1`. Prindi tulemus ekraanile.
3. Vali välja jaamad, kus temperatuur on olnud -17 või alla selle. Kasuta valiku tegemisel tõeväärtusvektorit ja kandilisi sulge `[]`. Omista saadud alamvektor muutujale `vastus2`.  Prindi tulemus ekraanile.
