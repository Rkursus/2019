---
title: 'Rakendustarkvara: R. Sügis 2018, 5. praktikum^[Praktikumijuhendid põhinevad aine MTMS.01.092 Rakendustarkvara: R (2 EAP) materjalidel, mille autorid on Mait Raag ning Raivo Kolde]'
output: 
  html_document:
    theme: null
...
mk <- read.table("http://kodu.ut.ee/~annes/Rkursus/maakonnad.txt", sep = " ")
library(ggplot2)
```
...
visiidid <- read.table("http://kodu.ut.ee/~annes/Rkursus/visiidid.txt", sep = "\t", header = TRUE)[1:5, ]
str(visiidid)
...
inimesed <- read.table("http://kodu.ut.ee/~annes/Rkursus/isikud.txt", sep = "\t", header = TRUE)
